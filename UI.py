...
class Window(Frame):
    ...
    def create_lowerentries(self):
        ...
        AnimeList=df.loc[0:10, ~df.columns.str.match("Unnamed")]
    ...
    # Anime Titles Column    
        ...
        for i in range(0, length):
            ...
            Button(self.lowerframe, text=AnimeList.loc[i]['Title'], command=lambda *args: anime_click(AnimeList['Title'][i])).grid(row=r, column=c+1, pady=4, padx=0, sticky = W)
    ...
    # Anime Intensity
        ...
        for i in range(0, length):
            ...
            Label(self.lowerframe, text=AnimeList.loc[i]['Genres']).grid(row=r2, column=c+2, pady=4, padx=0, sticky = W)
        ...
        for i in range(0, length):
            ...
            Label(self.lowerframe, text=AnimeList.loc[i]["Ratio"]).grid(row=r, column=c+3, pady=4, padx=0, sticky = W)
            self.lowerframe.grid_columnconfigure(c+1, weight=1)
